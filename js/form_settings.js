...
/******/ 	return __webpack_require__(__webpack_require__.s = "./js/src/form_settings.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./js/src/form_settings.js":
/*!*********************************!*\
  !*** ./js/src/form_settings.js ***!
  \*********************************/
/*! no exports provided */
...
/* harmony import */ var _utilities__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utilities */ "./js/src/utilities.js");
...
/* global jQuery, gform_ppcp_form_settings_strings */


window.GFPPCPFeedSettings = null;

(function ($, strings) {
	var formData = strings.form_data[babel_runtime_core_js_object_keys__WEBPACK_IMPORTED_MODULE_0___default()(strings.form_data)[0]];
	...
	window.GFPPCPFeedSettings = {
		...
		addEventListeners: function addEventListeners() {
			var feedSettings = window.GFPPCPFeedSettings;
   ...
   */
		getFieldCache: function getFieldCache() {
			var fields = {
   ...
   */
		toggleTrialFields: function toggleTrialFields() {
			var priceFieldValue = this.fields.product.val();
   ...
   */
		initTrialFields: function initTrialFields() {
   ...
   */
		maybeShowAmountField: function maybeShowAmountField() {
   ...
   */
		updateTrialPriceOptions: function updateTrialPriceOptions() {
			var recurringPrice = this.fields.recurringAmount.find('option:selected').val();
			var trialProduct = this.fields.product.find('option[value="' + recurringPrice + '"]');
		...
		maybeDisplayInvalidPaymentMethodsNotice: function maybeDisplayInvalidPaymentMethodsNotice() {
			var container = this.fields.transactionType.closest('div');
 ...
 */
(function ($) {
	var GFPayPalCheckoutUtils = {
		subscriptions: {
			getNoticeContainer: function getNoticeContainer() {
				return $('#gf-paypal-checkout-unsupported-payment-warning');
			},

			getUnsupportedPaymentMethodMarkup: function getUnsupportedPaymentMethodMarkup() {
